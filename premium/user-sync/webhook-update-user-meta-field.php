<?php
//This will allow you to update a Wordpress user meta field with the Interest groups that are set in MailChimp  when syncing data from MailChimp to Wordpress via the 2 way sync webhook.
